...
namespace QuanLyCuaHangTapHoa.Controllers
{
    public class NhaCungCapsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNhaCungCap,TenNhaCungCap,SoDienThoai")] NhaCungCap nhaCungCap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNhaCungCap,TenNhaCungCap,SoDienThoai")] NhaCungCap nhaCungCap)
        {
            if (ModelState.IsValid)
            {
